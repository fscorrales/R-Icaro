...
ActualizarRecursosSIIFUI <- function(id) {
  
  ns <- NS(id)
  
  tabPanel("Subsistema Recursos SIIF",
           useShinyjs(),
           sidebarLayout(
                          ...
                          tabsetPanel(id = ns("switcher"), type = "hidden",
                            tabPanel("1",
                                     ...
                                     p(style="text-align: center;",
                                       strong("Comprobantes Recursos SIIF")),
                                     p(style="text-align: center;",
                                       strong("Reporte rci02")),
                                     ...
                                     fluidRow(
                                       column(12, align = "center",
                                              ExportButtonUI(ns("SaveActualizaComprobantesRecursosSIIF"),
                                                             "Guardar .xlsx"))
                                     )
                       ...
                       fluidRow(
                         ...
                         column(11, 
                                tabsetPanel(id = ns("controller"),
                                            tabPanel("Recursos", value = "1", 
                                                     ReacTableUI(ns("DTActualizaComprobantesRecursosSIIF")))
...
ActualizarRecursosSIIFServer <- function(id) {
  moduleServer(id, function(input, output, session) {
    ...
    #DataTable
    ReacTableServer("DTActualizaComprobantesRecursosSIIF", ComprobantesRecursosSIIF.df,
                    selection = NULL)

    #Buttons
    ExportButtonServer("SaveActualizaComprobantesRecursosSIIF", ComprobantesRecursosSIIF.df,
                       "ComprobantesRecursosSIIF", "xlsx")
