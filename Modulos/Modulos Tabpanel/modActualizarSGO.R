...
ActualizarSGOUI <- function(id) {
  
  ns <- NS(id)
  
  tabPanel("Sistema Gestión Obras (SGO)",
           useShinyjs(),
           sidebarLayout(
                          ...
                          tabsetPanel(id = ns("switcher"), type = "hidden",
                            tabPanel("1",
                                     ...
                                     p(style="text-align: center;",
                                       strong("Listado Obras SGO")),
                                     p(style="text-align: center;",
                                       strong("Archivo exportable SGO")),
                       ...
                       fluidRow(
                         ...
                         column(11, 
                                tabsetPanel(id = ns("controller"),
                                            tabPanel("Obras SGO", value = "1", 
                                                     DataTableUI(ns("DTActualizaObrasSGO")))
...
ActualizarSGOServer <- function(id) {
  moduleServer(id, function(input, output, session) {
    ...
    DataTableServer("DTActualizaObrasSGO", ObrasSGO.df)
